...
/**
 * States the factors of a given number
 * @author Rose
 */
public class Main {
  ...
  public static void main(String[] args) {
    ...
    if (userNum >= 0){
     ...
     //create while loop to divide the users number by every integer
     while (userNum > 0){
      divisor = divisor + 1;

      //declare variable to store the remainder of the quotient of the users number and the divisor
